...
- Manages batting order and defensive positions
- Feeds player/lineup data to Stats (who's batting), Sound (who's walking up), and Live (overlay data)
- Must handle substitutions cleanly — changes here cascade to all other apps
- Print-friendly lineup card export is a likely feature
- This app is the **authority** for: batting order, defensive assignments, roster, substitutions
